...
import { HiSparkles, HiCheckCircle, HiArrowLeft, HiArrowUpTray } from 'react-icons/hi2'
...
export function ProductEditorForm({ product }: { product?: Product }) {
  ...
  const [specs] = useState<string[]>(product?.specs || ['High durability build', '1 Year warranty'])
  ...
  // File Upload Handler via storageService
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div>
                <label className="text-[11px] font-bold uppercase text-slate-600 block mb-1">Discount Tag</label>
                <input
                  type="text"
                  value={discountBadge}
